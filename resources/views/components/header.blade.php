        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img class="admin-logo-sm" src="{{ asset('admin/assets/images/logo1.jpg') }}" alt="logo-sm-light" height="22">
                    </span>
                    <span class="logo-lg">

                        <img class="admin-logo" src="{{ asset('admin/assets/images/logo2.jpg') }}" alt="logo-light" height="20">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                {{-- <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="px-lg-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="https://github.com/ferdinalaxewall" target="_blank">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item text-danger" href="{{ route('vendor.logout') }}"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a> --}}

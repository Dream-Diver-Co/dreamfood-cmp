            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('user.orders', ['userId' => auth()->user()->id]) }}">Order List</a></li>
                    </ul>
                </li>
                ...
                {{-- <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="ri-mail-send-line"></i>
                        <span>Special Day Gift</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('special')}}">Special Gift List</a></li>
                    </ul>
                </li> --}}
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('user.gift.status', ['userId' => auth()->id()]) }}">07 Order Gift</a></li>
                        <li><a href="{{ route('special')}}">Special Gift List</a></li>

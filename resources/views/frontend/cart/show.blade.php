        ...
        <div class="col-lg-4 offset-lg-8 col-md-6 offset-md-6 col-sm-8 offset-sm-2">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-right font-weight-bold">Total: <span id="overall-total">${{ number_format($cartItems->sum('total_price'), 2) }}</span></h3>
        ...
        <div class="col-lg-4 offset-lg-8 col-md-6 offset-md-6 col-sm-8 offset-sm-2">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    {{-- <h3 class="text-right font-weight-bold">Total Cashback Earned: <span id="total-cashback">${{ number_format($totalCashback, 2) }}</span></h3> --}}
                    {{-- <h3 class="text-right font-weight-bold">Total: <span id="overall-total">${{ number_format($item->total_price, 2) }}</span></h3> --}}
                    <h3 class="text-right font-weight-bold">Total: <span id="overall-total">
                        ${{ number_format($cartItems->sum(fn($item) => $item->product ? $item->product->price * $item->quantity : 0), 2) }}
                    </span></h3>

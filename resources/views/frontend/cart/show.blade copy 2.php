                    ...
                    <div class="card-header">
                        ...
                        <div id="coupon-response" class="mt-2"></div>
                            ...
                            {{-- <div class="cart-total">
                                ...
                                <h3><strong>Applicable Cashback Discount:</strong> ${{ number_format($applicableCashbackDiscount, 2) }}</h3>

                                <!-- Button to apply cashback discount -->
                            ...
                            <div class="cart-total">
                                ...
                                @else
                                    <h3><strong>Total Cashback:</strong> $<span id="total-cashback">0.00</span></h3>
                                    <h3><strong>Applicable Cashback Discount:</strong> $0.00</h3>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#cashback-response').html('<div class="alert alert-danger">Failed to apply cashback discount.</div>');
                    }
                },
                error: function(xhr) {
